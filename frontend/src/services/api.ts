...
const API_URL = typeof import.meta.env.VITE_API_URL !== 'undefined' ? import.meta.env.VITE_API_URL : "https://api.ardvmeetinghub.com";
...
api.interceptors.request.use((config) => {
  const token = localStorage.getItem("ardvmeetinghub_token");
