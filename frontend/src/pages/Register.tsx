  ...
  return (
    <main className="bg-premium grid min-h-screen place-items-center p-6 text-slate-900 dark:text-white transition-colors">
      <Card className="w-full max-w-md p-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-white/5">
        <div className="mb-6 flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-lg bg-cyan-500 dark:bg-cyan-400 text-white dark:text-slate-950"><Video size={22} /></span><div><h1 className="text-2xl font-bold">Create your Ardvmeetinghub account</h1><p className="text-sm text-slate-500 dark:text-slate-400">Start meeting in under a minute.</p></div></div>
